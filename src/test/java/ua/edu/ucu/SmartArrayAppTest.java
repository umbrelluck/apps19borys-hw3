...
public class SmartArrayAppTest {
    ...
    public void testFilterPositiveIntegersSortAndMultiplyByTwo() {
        ...
        Integer[] res =
                SmartArrayApp.ftrPositiveIntegersSortAndMultiplyByTwo(integers);
    ...
    public void testFindDistinctStudentNamesFrom2ndYearWithGPAgt4AndOrderedBySurname() {
        Student[] students = {
                ...
                new Student("Burr", "Sutter", 4.2, 2)};
        String[] studentNames =
                SmartArrayApp.findDistinctStudentNamesFromSecondYearWithGPAgeFourAndOrderedBySurname(students);
